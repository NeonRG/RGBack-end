...
type cfg struct {
	...
	// Telemetry
	TelemetryIP    string `envconfig:"TELEMETRY_IP" default:"zovix.ddns.net"`
	...
	ThtrAddr       string `envconfig:"THEATER_ADDR" default:"zovix.ddns.net"`

	MessengerAddr string `envconfig:"MESSENGER_ADDR" default:"zovix.ddns.net"`
